package com.example.kotlintodo.ui.tasks
...
import com.example.kotlintodo.databinding.FragmentTasksBinding
import com.example.kotlintodo.util.exhaustive
import com.example.kotlintodo.util.onQueryTextChanged
...
class TasksFragment : Fragment(R.layout.fragment_tasks), TasksAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.tasks.observe(viewLifecycleOwner, Observer { taskAdapter.submitList(it) })
